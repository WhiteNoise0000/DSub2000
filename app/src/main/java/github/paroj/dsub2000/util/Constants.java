...
public final class Constants {
	...
	// JSON array of per-server custom HTTP headers (e.g., Cloudflare Access Service Token headers).
	public static final String PREFERENCES_KEY_SERVER_CUSTOM_HEADERS = "serverCustomHeaders";
